...
<head>
    ...
    <title>Login Visitante - SENA</title>
    ...
    <style>
        :root {
            ...
            --visitor-gray: #6c757d;
            --visitor-dark-gray: #495057;
            --visitor-light-gray: #868e96;
        }

        body {
            background: linear-gradient(135deg, var(--visitor-gray) 0%, var(--visitor-dark-gray) 100%);
            min-height: 100vh;
        ...
        .login-header::before {
            ...
            border-top: 10px solid var(--visitor-dark-gray);
        }
        ...
        .btn-login:hover {
            ...
            background: linear-gradient(135deg, var(--visitor-light-gray) 0%, var(--visitor-gray) 100%);
        }
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-body">
                ...
                <form method="POST" action="{{ route('login.visitante.process') }}">
                    @csrf
